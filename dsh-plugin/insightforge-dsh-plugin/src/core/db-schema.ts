 ...
 * - 仅保留插件侧需要的 market_needs 表与 FTS5 触发器
 * - users / projects / project_reports / executions 由个人版管理,插件侧通过
 *   FTS5 全文检索消费 market_needs 即可
 *
 * 复用 FAQ Q4 的"同一份需求库"语义:用户可在 cordis.yml 中通过 dbPath
 * 指向个人版的 ./data/insightforge.db,本插件会自动检测并复用。
 */
